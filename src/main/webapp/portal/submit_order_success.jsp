...
<div id="listDiv">
    ...
    <br/> <br/>
    <div>
        <a href="product_list" class="btn btn-primary btn-sm" role="button">&lt;&lt; Tiếp tục mua sắm</a>

        <a href="order_detail?order_id=${orderId}" class="btn btn-primary btn-sm" role="button">Xem chi tiết đơn hàng
            &gt;&gt;</a>
